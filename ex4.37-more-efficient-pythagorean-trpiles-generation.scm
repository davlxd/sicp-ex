; Yes I think so because this solution reduce a amb spece to search
; Especially if space is large
; if the overhead of sqrt dones't overweigh (not likely), then this
...
(a-pythagorean-triple-between2 1 100)
try-again
try-again
try-again
