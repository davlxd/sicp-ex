...
(define (parse input)
  ...
  (let ((sent (parse-compound-sentence))) ; extend compound
...
(parse '(the bald professor lectures))
try-again

(parse '(the professor lectures to the bald poor student with the hard-working cat))
try-again
try-again


(parse '(the professor lectures drastically dramatically to the bald poor student with the hard-working cat))
try-again
try-again


(parse '(the professor lectures drastically dramatically to the bald poor student but the student sleeps dramatically))
try-again

(parse '(the professor lectures to the bald poor student but the student sleeps dramatically and a cat eats dramatically drastically in the class))
try-again
