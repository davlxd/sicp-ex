...
(define (apply procedure arguments)
  (newline)
  (write-line (list "apply" procedure arguments))
...
(define (eval exp env)
  ...
  ;(write-line (list-of-values (operands exp) env))
...
; Louis's map failed because in the above evaluator, 
; the operator argument will be evaled by our evaluator and turned into something
; that the underlying Lisp cannot recognize
; For instance
;   - primitive operators will be wrapped into '(primitive <actual>)
;   - lambda turns into '(procedure ....) 
;
