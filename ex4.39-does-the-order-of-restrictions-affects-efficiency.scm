...
(define (multiple-dwelling)
  (let ((baker (amb 1 2 3 4 5))
        ...
        (smith (amb 1 2 3 4 5)))
    (require
      (distinct? (list baker cooper fletcher miller smith))) ; reduce from 5^5 to 5 x 4 x 3 x 2 x 1
    (require (not (= baker 5))) ; reduce by 1/5
    (require (not (= cooper 1))) ; ...
    (require (not (= fletcher 5))) ; ...
    (require (not (= fletcher 1))) ; ...
    (require (> miller cooper)) ; reduce by 1/2
    (require (not (= (abs (- smith fletcher)) 1))) ; reduce by 17/25
...
(execution-time multiple-dwelling)


; But it looks like the current order already serve my purpose
;
;
...
(define (multiple-dwelling2)
  (let ((baker (amb 1 2 3 4 5))
    ...
    (require (not (= fletcher 5))) ; ...
    (require (not (= fletcher 1))) ; ...
    (require (distinct? (list baker cooper fletcher miller smith))) ; reduce from 5^5 to 5 x 4 x 3 x 2 x 1
    (list (list 'baker baker)
          (list 'cooper cooper)
          (list 'fletcher fletcher)
          (list 'miller miller)
...
; On my machine after several runs:
; 674 vs 771
; 648 vs 779
; 654 vs 773
