...
(=zero? (make-poly 'y (the-empty-termlist)))
(=zero? (make-poly 'y (adjoin-term (make-term 2 (make-rational 4 3)) (the-empty-termlist))))
(=zero? (make-poly 'y (adjoin-term (make-term 2 (make-rational 0 3)) (the-empty-termlist))))
