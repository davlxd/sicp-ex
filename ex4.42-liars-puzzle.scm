...
(define (one-true-one-unture s1 s2)
  (cond ((and s1 s2) (amb))
        ((and (not s1) (not s2)) (amb))
        (else 'go)))
...
(define (liars)
  (let ((betty (amb 1 2 3 4 5))
    ...
    (one-true-one-unture (= kitty 2) (= betty 3))
    (one-true-one-unture (= ethel 1) (= joan 2))
    (one-true-one-unture (= joan 3) (= ethel 5))
    (one-true-one-unture (= kitty 2) (= marry 4))
    (one-true-one-unture (= marry 4) (= betty 1))
