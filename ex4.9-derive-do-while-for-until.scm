...
; Basic idea would be use named procedure, but we also need to avoid name conflicts,
; so my solution is constructing a new env frame, meaning wrapping up with lambda then invoke directly
;
; so for Do:
; (do
;    (
...
; 
; Apparently we need stub for set! as well
