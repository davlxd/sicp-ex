...
;; duplicate/export terms operations for testing purpose
(define (adjoin-term term term-list)
  (if (=zero? (coeff term))
    term-list
    (cons term term-list)))
...
(define divided-terms (div-terms
                        '((5 3) (0 -1))
                        '((2 1) (0 -1))))
divided-terms
(car divided-terms)
(cadr divided-terms)
(add-terms (cadr divided-terms)
           (mul-terms (car divided-terms)
                      '((2 1) (0 -1))))

;
; Above is ex2.78 and ex2.91
;
;
;
;
(define (gcd-terms a b)
  (newline)
  (write-line "For gcd-terms")
  (write-line (list a b))
  (if (empty-termlist? b)
    a
    ((lambda ()
       (newline)
       (write-line "For div-terms")
       (write-line (list a b))
       (write-line (div-terms a b))
       ; (write-line "Recover...validation...")
       ; (write-line (add-terms (cadr (div-terms a b)) (mul-terms (car (div-terms a b)) b)))
       (gcd-terms b (cadr (div-terms a b)))
       ))))

; (gcd-terms '((4 1) (3 1) (2 1) (1 -2) (0 -1)) '((5 1) (3 -1) (2 -1) (0 1)))

(gcd-terms '((4 1) (3 1) (2 1) (1 -2) (0 -1)) '((5 1) (3 -1) (2 -1) (0 1)))
(gcd-terms '((5 1) (3 -1) (2 -1) (0 1))  '((4 1) (3 1) (2 1) (1 -2) (0 -1)) )

; It should be '((1 1) (0 -1)) but unfortunately it's '((1 -7/36) (0 7/36))
; Not wrong but not the concise version

(div-terms '((4 1) (3 1) (2 1) (1 -2) (0 -1)) '((1 1) (0 -1)))
(div-terms '((5 1) (3 -1) (2 -1) (0 1)) '((1 1) (0 -1)))

(div-terms '((4 1) (3 1) (2 1) (1 -2) (0 -1)) '((1 -7/36) (0 7/36)))
(div-terms '((5 1) (3 -1) (2 -1) (0 1)) '((1 -7/36) (0 7/36)))
